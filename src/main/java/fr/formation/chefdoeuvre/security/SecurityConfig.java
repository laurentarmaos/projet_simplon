...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// disable unused default configurations:
	http.csrf().disable().httpBasic().disable().sessionManagement()
		.sessionCreationPolicy(SessionCreationPolicy.STATELESS)
		// apply business requirements (security)
		.and().authorizeRequests().antMatchers(HttpMethod.POST, "/rezhotel/create-user", "/rezhotel/login")
		.permitAll()
//		// unauthorized any other endpoints:
